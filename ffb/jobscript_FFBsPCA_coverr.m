function [ timing, coeff, mean_coeff, sPCA_coeff, U, D, err_cov ] = jobscript_FFBsPCA_coverr(data, R, noise_variance, basis, sample_points, num_pool, tr_coeff)
%Description:
...
tic_start2 = tic;
[ U, D, sPCA_coeff, mean_coeff, err_cov ] = sPCA_whole_coverr(tr_coeff, coeff, basis, noise_variance);
